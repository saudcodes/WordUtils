            ...
            <div className="container ">
                ...
                <form className="was-validated">
                    ...
                    <div className="container my-3 buttons">
                        <button style={props.mode === "light" ? { color: "white" } : props.myColor} className="btn mx-2  btn-primary" onClick={handleUpperCase} type="submit">To uppercase</button>
                        <button style={props.mode === "light" ? { color: "white" } : props.myColor} className="btn mx-2 btn-primary" onClick={handleLowerCase} type="submit">To lowercase</button>
                        <button style={props.mode === "light" ? { color: "white" } : props.myColor} className="btn mx-2 btn-primary" onClick={handleCapitalize} type="submit">To capitalize</button>
                        ...
                        <button style={props.mode === "light" ? { color: "white" } : props.myColor} className="btn mx-2 btn-primary" onClick={handleCopyText} type="submit">Copy </button>
                    </div>
